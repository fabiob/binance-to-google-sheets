...
const SPOT_API_URL = "https://api-gcp.binance.com"; // Google Cloud specific endpoint: https://binance-docs.github.io/apidocs/spot/en/#general-api-information
const VISION_API_URL = "https://data-api.binance.vision";
